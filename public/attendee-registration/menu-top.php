...
<?php
	$organizer_id = isset($_GET['user_id']) ? $_GET['user_id'] : 0 ;	
	$sql = "SELECT * FROM eventic_user where id = '".$organizer_id."'";
	$user = $conn->query($sql);
	$user_row = $user->fetch_row();
	$user_name = isset($user_row[6]) ? $user_row[6] : '';
?>
<html lang="en">
<head>
	<meta charset="utf-8" />
				...
				<div class="widgets-wrap d-flex justify-content-end">
					<div class="widget-header dropdown">
						<a href="#" class="ml-3 icontext" data-toggle="dropdown" onclick="openDashboardSideNav()">
							...
							<div class="text-wrap ">
								<span><?= isset($user_name) ? $user_name : ''?> <i class="fas fa-caret-down"></i></span>
							</div>
						</a>
